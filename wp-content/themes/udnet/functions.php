...
add_action('wp_enqueue_scripts', function () {
    ...
    wp_register_style('site', THEME_URL . '/css/site.css', $styles_array, '12', 'all');
    wp_enqueue_style('site');

    wp_register_script('site', THEME_URL . '/js/site.js', $scripts_array, '12', true);
...
add_action('wp_dashboard_setup', function () {
    ...
    wp_add_dashboard_widget('dashboard_widget', 'Wordpress programmer', function () {
        echo 'Developed by Ivan Smirnov';
    });
});
